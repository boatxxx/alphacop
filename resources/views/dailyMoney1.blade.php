  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        <div>บริษัท รักษาความปลอดภัย แอลฟา คอพ จำกัด</div>
        <div>            หมู่ที่ 7 555/50 ตำบล บ้านเลื่อม <br />อำเภอเมืองอุดรธานี อุดรธานี 41000
             ประเทศไทย</div>
        <div>  095 185 0989</div>
        <div><a href="mailto:company@example.com">Alphacop9@gmail.com</a></div>


        <div><span>วันที่ประกาศ </span>{{ $currentDate }}</div>
      </div>
      <div id="project">
        <div><span>บริษัท</span> บริษัท รักษาความปลอดภัย แอลฟา คอพ จำกัด</div>
...
@endforeach
      ...
      <div id="notices">
        <div><h1>ลงชื่อ:</h1></div>
        <div class="notice">บริษัท รักษาความปลอดภัย แอลฟา คอพ จำกัด
            หมู่ที่ 7 555/50 ตำบล บ้านเลื่อม อำเภอเมืองอุดรธานี อุดรธานี 41000<br>
           เบอร์ติดต่อ 095 185 0989
           อีเมล Alphacop9@gmail.com</div>
      </div>
    </main>
    <footer>
