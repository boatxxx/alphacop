      ...
      <table>
        ...
        <tbody>
            <tr>
              ...
              <tr>
                <td class="desc"></td>
                <td class="desc"><p>เงินเดือน {{ $baseSalary}} บาท
                <td class="qty">{{ $baseSalary}}</td>
                <td class="total">{{ $baseSalary}}</td>
                <td class="total">{{ $baseSalary}}</td>
...
@endforeach
              ...
              <tr>
                ...
                <td class="total">{{ $moneyall2 =  ($amount1 ?? 0)}}</td>
              </tr>
              <tr>
          ...
          <tr>
              ...
              <td class="total">{{ $tax =($baseSalary+($amount1?? 0))* 0.03}}</td>
          </tr>
          <tr>
              <td colspan="4">รวมยอดรายการหัก</td>
              <td class="total">{{ $moneyall3 = $tax + ($amount?? 0) }}</td>
          </tr>
